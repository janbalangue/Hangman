...
var composers = [
    ...
    ["untested", "Bach", "Johann Sebastian", "1685-1750", "Cello Suite No. 1 - Prelude", "Yo-Yo Ma, Cello", '<iframe width="560" height="315" src="https://www.youtube.com/embed/PCicM6i59_I?autoplay=1&rel=0&amp;controls=0&amp;showinfo=0&amp;start=4" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>']
];
...
document.onkeyup = function (event) {
    ...
    if (keyCommand in alphabet) {
        ...
        for (var i = 0; i < puzzleAnswer.length; i++) { // update "word-blanks" and "wrong-guesses" IDs in index.html
            ...
            } else if (puzzleAnswer.charAt(i) in alphabet && alphabet[keyCommand] === "unselected") {
                answerSoFar += "_ ";
            }
        }
        document.getElementById("word-blanks").innerHTML = answerSoFar;
